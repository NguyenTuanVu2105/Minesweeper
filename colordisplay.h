...
struct Image {
    ...
    {
        ColorCharacter colorcharacter; colorcharacter.color = GREEN; colorcharacter.character = ' ';
...
void fillBlock(Image &block,short color,char ch);  //to mau cho 1 khoi
